...
//         try {
//             const response = await fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/users/login`, {
//                 method: 'POST',
//                 headers: {
...
//         try {
//             const response = await fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/users/details`, {
...
function authenticate(e) {
    ...
    fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/users/login`, {
        method: 'POST',
        headers: {
            "Content-Type": "application/json"
        },
